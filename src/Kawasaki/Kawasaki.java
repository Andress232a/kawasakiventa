...
public class Kawasaki extends javax.swing.JFrame {

    String[] productos = {"KAWASAKI ZH2", "NINJA ZX-10R", "KMX 125", "Z400", "VERSYS 650", "NINJA 400 KRT",
        "JET SKI STX 160 LX", "VERSYS 1000 S", "KLX 150J"};
    double[] precios = {124990000, 95990000, 42900000, 35490000, 52990000, 35990000, 95990000, 84990000, 25500000};
    double precio = 0;
    int cantidad = 0;
    ...
    public Kawasaki() {
        initComponents();
        this.setTitle("TIENDITA KAWASAKI");
        Image icono = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/Logo.jpg"));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(Importe, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
    ...
    public String estiloMoneda(double precio) {
        return "$ " + Math.round(precio * 1) / 1 + " COP";
    }
